...
Erro:
    ...
    Public Function DBExecutar_LinhaAfetadas(ByVal SqlText As String, _
        ...
        Catch eDB As OracleException
            MsgErr = eDB.Message
            Call Erro_Tratar("MOD_DB.DBExecutar_LinhaAfetadas (OracleException)", SqlText)
            Return False
        Catch ex As Exception
            Call Erro_Tratar("MOD_DB.DBExecutar_LinhaAfetadas (Exception)", SqlText)
            Return False
        End Try
    End Function
...
Erro:
    ...
    Public Function DBQuery_ValorUnico_Lista(ByVal SqlText As String, _
                                             Optional ByVal Separador As String = ",", Optional ByVal bNumber As Boolean = True) As String
        Dim oData As DataTable
        Dim iCont As Integer
        Dim sAux As String = ""
    ...
    Public Function DBCarregarUsuario() As Boolean
        ...
        DBExecutar("insert into sof.tmp_coneccao values ('" & sAcesso_UsuarioLogado & "')")
