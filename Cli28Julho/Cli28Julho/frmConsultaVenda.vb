...
Public Class frmConsultaVenda
  ...
  Const const_GridListagem_DH_Cancelamento As Integer = 11
  Const const_GridListagem_Obs_Cancelamento As Integer = 12
  Const const_GridListagem_TP_REALIZADO As Integer = 13
  Const const_GridListagem_IC_QUITADA As Integer = 14
  Const const_GridListagem_NO_CANALMARCACAO As Integer = 15
  Const const_GridListagem_SQ_MOVFINANCEIRA As Integer = 16
  ...
  Private Sub Pesquisar()
    ...
    objGrid_ExibirTotal(grdListagem, New Integer() {const_GridListagem_VlrTotalProcedimento, const_GridListagem_VlrDesconto})
