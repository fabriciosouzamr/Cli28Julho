...
Public Class frmLancaContasReceberPagar_Venda
  ...
  Private Sub cmdGravar_Click(sender As Object, e As EventArgs) Handles cmdGravar.Click
    ...
    If Math.Round(txtValorDesconto.Value, 2) >
  ...
  Private Sub CalcularTotalAPagar()
    Try
      txtValorTotalAPagar.Value = txtValorTotalLancamento.Value - txtValorDesconto.Value - txtValorVoucher.Value

      lblValorPendenteLancado.Text = lblValorPendenteLancado.Tag.ToString().Trim() & " " & (txtValorTotalLancamento.Value - txtValorTotalAdicionado.Value - txtValorDesconto.Value - txtValorVoucher.Value)
  ...
  Private Sub cmdValidarDesconto_Click(sender As Object, e As EventArgs) Handles cmdValidarDesconto.Click
    ...
    If oForm.Autorizado Then
      ...
      txtValorDesconto.Value = oForm.ValorDesconto
    End If
  End Sub
