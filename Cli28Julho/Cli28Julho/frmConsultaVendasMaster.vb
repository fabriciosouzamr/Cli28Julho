...
Public Class frmConsultaVendasMaster
  ...
  Private Sub Pesquisar()
    ...
    sSqlText = "SELECT PLCCR.NO_PLANOCONTAS AS NO_PLANOCONTAS_CR," &
                      ...
                      "ROUND(ISNULL(MVFCR.VL_DESCONTO, 0) / MVFCR.VL_ORIGINAL * CVPCD.VL_PROCEDIMENTO, 2)," &
                      "CVPCD.VL_PROCEDIMENTO - ROUND(ISNULL(MVFCR.VL_DESCONTO, 0) / MVFCR.VL_ORIGINAL * CVPCD.VL_PROCEDIMENTO, 2) AS VL_LIQUIDO," &
                      "CVPCD.VL_REPASSE," &
               ...
               " FROM TB_CLINICA_VENDA CLVND" &
                ...
                " INNER JOIN TB_PESSOA ATEND ON ATEND.SQ_PESSOA = CLVND.ID_PESSOA_ATENDENTE" &
                " INNER JOIN TB_CONVENIO CONVE ON CONVE.SQ_CONVENIO = CLVND.ID_CONVENIO" &
                ...
                " INNER JOIN TB_GRUPOPROCEDIMENTO GPPRC ON GPPRC.SQ_GRUPOPROCEDIMENTO = PROCE.ID_GRUPOPROCEDIMENTO" &
                " INNER JOIN TB_PESSOA PROFI ON PROFI.SQ_PESSOA = CVPCD.ID_PESSOA_PROFISSIONAL" &
                ...
                " LEFT JOIN TB_PLANOCONTAS PLCCR ON PLCCR.SQ_PLANOCONTAS = GPPRC.ID_PLANOCONTAS" &
                " LEFT JOIN TB_PLANOCONTAS PLCCP ON PLCCP.SQ_PLANOCONTAS = GPPRC.ID_PLANOCONTAS_CONTASPAGAR" &
                ...
                " LEFT JOIN TB_ESPECIALIDADE ESPEC ON ESPEC.SQ_ESPECIALIDADE = AGEND.ID_ESPECIALIDADE" &
                " LEFT JOIN TB_OPCAO OPCAO_DIASM ON OPCAO_DIASM.CD_OPCAO = CAST(DATEPART(W, CLVND.DH_VENDA) AS CHAR)" &
