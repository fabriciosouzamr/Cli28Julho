Public Class frmCadastroAtendimentoExecucao
  ...
  Private Sub Carregar()
    ...
    Else
      VScrollBar.Enabled = (cListagem.Length > 15)
      If cListagem.Length - 15 > 0 Then VScrollBar.Maximum = cListagem.Length - 14 Else VScrollBar.Maximum = 1
    End If
  ...
  Private Sub cmdAtender01_Clicado(sender As Object) Handles cmdAtender01.Clicado, cmdAtender02.Clicado, cmdAtender03.Clicado,
    ...
    sSqlText = "UPDATE TB_AGENDAMENTO" &
               " SET DH_EXECUTOR_ATENDIMENTO = GETDATE()," &
                    "ID_OPT_STATUS = " & enOpcoes.StatusAgendamento_Atendido.GetHashCode() &
               " WHERE SQ_AGENDAMENTO = " & oHora.Tag
    DBExecutar(sSqlText)
