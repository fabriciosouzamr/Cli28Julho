...
Public Class frmConsultaConvenioProfissional
  ...
  Private Sub frmConsultaConvenioProfissional_Load(sender As Object, e As EventArgs) Handles MyBase.Load
  ...
  Private Sub Pesquisar()
    ...
    If ComboBox_Selecionado(cboProfissional) Then
      FNC_Str_Adicionar(sSqlText_Where, "CVPCD.ID_PESSOA_PROFISSIONAL = " & cboProfissional.SelectedValue, " AND ")
    End If
