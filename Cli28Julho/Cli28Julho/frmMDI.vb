...
Public Class frmMDI
  ...
  Public Sub Senha_ContaCaixa()
    ...
    Do While (True)
      If iSenha_ContaCaixaAtendimento > 0 Then
        ...
        sSqlText = "SELECT * FROM VW_CLINICA_SENHA_ULTIMA_SENHA_CHAMADA_HOJE WHERE ID_EMPRESA = " & iID_EMPRESA_FILIAL
        ...
        sSqlText = "SELECT NR_CLINICA_SENHA FROM VW_CLINICA_SENHA_ULTIMA_SENHA_GERADA_HOJE WHERE ID_EMPRESA = " & iID_EMPRESA_FILIAL
        ddbSenha_UltimaSenhaGerada.Text = ddbSenha_UltimaSenhaGerada.Tag & " " & FNC_StrZero(DBQuery_ValorUnico(sSqlText, 0).ToString(), 3)
  ...
  Private Sub ddbSenha_ContaCaixa_ChamarSenha_Chamar()
    ToolStripDropDownButton_Carregar(ddbSenha_ContaCaixa_ChamarSenha, enSql.ClinicaSenhaGerada_Hoje, AddressOf Senha_ContaCaixa_Chamar)
  End Sub
