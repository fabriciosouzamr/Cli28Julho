...
Public Class frmConsultaVendaPendente
  ...
  Private Sub Pesquisar()
    ...
    If IsDate(txtDataVendaInicial.Text) Then
      FNC_Str_Adicionar(sSqlText_Where, " CAST(DH_ITEM AS DATE) >= " & FNC_QuotedStr(txtDataVendaInicial.Text), " AND ")
    End If
    If IsDate(txtDataVendaFinal.Text) Then
      FNC_Str_Adicionar(sSqlText_Where, " CAST(DH_ITEM AS DATE) <= " & FNC_QuotedStr(txtDataVendaFinal.Text), " AND ")
    End If
