...
Public Class frmConsultaOrcamento
  ...
  Const const_GridListagem_CD_CPF_CNPJ As Integer = 6
  Const const_GridListagem_NO_PESSOA As Integer = 7
  Const const_GridListagem_NO_CONVENIO As Integer = 8
  Const const_GridListagem_NO_FINANCIAMENTO As Integer = 9
  Const const_GridListagem_NO_OPT_STATUS As Integer = 10
  Const const_GridListagem_NO_USUARIO As Integer = 11
  ...
  Private Sub frmConsultaOrcamento_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    objGrid_Coluna_Add(grdListagem, "C.P.F./C.N.P.J.", 130)
  ...
  Private Sub cmdPesquisar_Click(sender As Object, e As EventArgs) Handles cmdPesquisar.Click
    ...
    sSqlText = "SELECT OCCLI.SQ_ORCAMENTO_CLIENTE," +
                      ...
                      "OCCLI.DT_VALIDADE," +
                      "dbo.FC_FormatarCPF_CNPJ(CD_CPF_CNPJ)," +
                      "PESSO.NO_PESSOA," +
                      "CONVE.NO_CONVENIO," +
               ...
               " FROM TB_ORCAMENTO_CLIENTE OCCLI" +
                ...
                " INNER JOIN TB_OPCAO OPCAO_STATU ON OPCAO_STATU.SQ_OPCAO = OCCLI.ID_OPT_STATUS" +
                 ...
                 " LEFT JOIN VW_HISTORICO_INCLUSAO HISTO ON HISTO.ID_REGISTRO = OCCLI.SQ_ORCAMENTO_CLIENTE" +
                                             " AND HISTO.ID_OPT_PROCESSO = " & enOpcoes.Processo_Historico_Agendamento_CadastroOrcamento.GetHashCode()
