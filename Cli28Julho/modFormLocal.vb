...
PESSOAFIN.NO_PESSOA AS PESSOA_CONTASAPAGAR
 FROM TB_MOVFINANCEIRA MVFNC
  ...
  INNER JOIN TB_AGENDAMENTO AGEND ON AGEND.SQ_AGENDAMENTO = CVPRC.ID_AGENDAMENTO OR AGEND.ID_CLINICA_VENDA_PROCEDIMENTO = CVPRC.SQ_CLINICA_VENDA_PROCEDIMENTO
