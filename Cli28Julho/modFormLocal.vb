...
Module modFormLocal
  ...
  Public Function FormCadastroPessoaEmpresa_GravarPessoa(iID_PESSOA As Integer,
    ...
    sSqlText = DBMontar_SP("SP_PESSOA_EMPRESA_CAD", False, "@ID_PESSOA",
                                                           ...
                                                           "@IC_PROFISSIONAL_RETEMIMPOSTO_GERARCP",
                                                           "@PC_PROFISSIONAL_RETEMIMPOSTO",
                                                           "@ID_PROFISSIONAL_CONSELHOPROFISSIONAL_UF",
                                                           "@DS_PROFISSIONAL_CBO",
    ...
    If DBExecutar(sSqlText, DBParametro_Montar("ID_PESSOA", iID_PESSOA),
                            ...
                            DBParametro_Montar("IC_PROFISSIONAL_RETEMIMPOSTO_GERARCP", IIf(bIC_PROFISSIONAL_RETEMIMPOSTO_GERARCP, "S", "N")),
                            DBParametro_Montar("PC_PROFISSIONAL_RETEMIMPOSTO", dPC_PROFISSIONAL_RETEMIMPOSTO),
                            DBParametro_Montar("ID_PROFISSIONAL_CONSELHOPROFISSIONAL_UF", FNC_NuloZero(iID_PROFISSIONAL_CONSELHOPROFISSIONAL_UF, False)),
                            DBParametro_Montar("DS_PROFISSIONAL_CBO", FNC_NuloString(sDS_PROFISSIONAL_CBO, False)),
  ...
  Public Sub FormMovimentacaoFinanceira_Status_Atualizar(iSQ_MOVFINANCEIRA As Integer)
    ...
    sSqlText = DBMontar_SP("SP_MOVFINANCEIRA_STATUS", False, "@SQ_MOVFINANCEIRA", "@ID_USUARIO")
    DBExecutar(sSqlText,
...
Sair:
  ...
  Public Sub FormCadastroAgendamento_Gravar(ByRef iSQ_AGENDAMENTO As Integer,
    ...
    DBExecutar(sSqlText, DBParametro_Montar("SQ_AGENDAMENTO", iSQ_AGENDAMENTO, , ParameterDirection.InputOutput),
                         ...
                         DBParametro_Montar("ID_PESSOA_HORARIO", FNC_NuloZero(ID_PESSOA_HORARIO)))
    ...
    DBExecutar(sSqlText, DBParametro_Montar("ID_EMPRESA", iID_EMPRESA),
                         DBParametro_Montar("ID_OPT_PROCESSO", enOpcoes.Processo_Historico_Clinica_Agendamento),
                         DBParametro_Montar("ID_OPT_ACAO", enOpcoes.Processo_Acao_Inclusao),
                         DBParametro_Montar("ID_OPT_ERRO", Nothing),
                         DBParametro_Montar("ID_USUARIO", iID_USUARIO),
                         DBParametro_Montar("ID_REGISTRO", iSQ_AGENDAMENTO),
                         DBParametro_Montar("CD_HISTORICO", sCD_AGENDAMENTO),
                         DBParametro_Montar("DT_HISTORICO", DateTime.Now),
                         DBParametro_Montar("DS_HISTORICO", "Inclusão realizada"),
                         DBParametro_Montar("DS_FILTRO", Nothing),
                         DBParametro_Montar("CD_VERSAO_SISTEMA", sSISTEMA_UltimaVersao),
  ...
  Public Sub FormCadastroAgendamento_AlterarStatus(iSQ_AGENDAMENTO As Integer,
                                                   ...
                                                   Optional ForcarStatus As Boolean = False)
    Dim sSqlText As String
    ...
    DBExecutar(sSqlText, DBParametro_Montar("SQ_AGENDAMENTO", iSQ_AGENDAMENTO),
                         ...
                         DBParametro_Montar("TP_FORCAR_STATUS", IIf(ForcarStatus, "S", "N")))
  End Sub
...
Sair:
  ...
  Public Function FormCadastroMovimentacaoFinanceiraParcela(ByRef iSQ_MOVFINANCEIRAPARCELA As Integer,
                                                            ...
                                                            dPC_TAXA_COMPENSACAO As Double,
                                                            dVL_IMPOSTORETIDO As Double) As Boolean
    Dim sSqlText As String
    Dim bOk As Boolean
    ...
    bOk = DBExecutar(sSqlText, DBParametro_Montar("SQ_MOVFINANCEIRAPARCELA", Val(FNC_NVL(iSQ_MOVFINANCEIRAPARCELA, 0)), , ParameterDirection.InputOutput),
                               ...
                               DBParametro_Montar("ID_TIPO_DOCUMENTO", FNC_NuloSe(iID_TIPO_DOCUMENTO, 0)),
                               ...
                               DBParametro_Montar("VL_IMPOSTORETIDO", dVL_IMPOSTORETIDO, SqlDbType.Float))
    If DBTeveRetorno() Then
  ...
  Public Sub FormCadastroHistorico_Gravar(iID_EMPRESA As Integer,
                                          iID_OPT_PROCESSO As Integer,
                                          iID_OPT_ACAO As Integer,
                                          iID_REGISTRO As Integer,
                                          sDS_HISTORICO As String,
                                          sDS_FILTRO As String,
                                          sCD_VERSAO_SISTEMA As String,
                                          sNO_COMPUTADOR_NOME As String,
                                          sCD_HISTORICO As String,
                                          iID_OPT_ERRO As Integer)
    Dim sSqlText As String

    sSqlText = DBMontar_Insert("TB_HISTORICO", TipoCampoFixo.DadoCriacao, "ID_EMPRESA", "@ID_EMPRESA",
                                                                          "ID_OPT_PROCESSO", "@ID_OPT_PROCESSO",
                                                                          "ID_OPT_ACAO", "@ID_OPT_ACAO",
    ...
    DBExecutar(sSqlText, DBParametro_Montar("ID_EMPRESA", iID_EMPRESA),
                         ...
                         DBParametro_Montar("DT_HISTORICO", Date.Now),
                         DBParametro_Montar("DS_HISTORICO", sDS_HISTORICO),
                         DBParametro_Montar("DS_FILTRO", sDS_FILTRO),
                         DBParametro_Montar("CD_VERSAO_SISTEMA", sCD_VERSAO_SISTEMA),
                         DBParametro_Montar("NO_COMPUTADOR_NOME", sNO_COMPUTADOR_NOME),
                         DBParametro_Montar("CD_HISTORICO", sCD_HISTORICO),
                         DBParametro_Montar("ID_OPT_ERRO", iID_OPT_ERRO))
  End Sub
  ...
  Public Sub FormRelatorioGuiaConsulta(iSQ_CLINICA_VENDA As Integer, bImprimir As Boolean)
    Try
      ...
      sSqlText = $"SELECT CVDPC.SQ_CLINICA_VENDA_PROCEDIMENTO,EMPRE.NO_PESSOA NO_EMPRESA,ENDE2.DS_ENDERECO DS_ENDERECO_PROFISSIONAL,
CVDPC.VL_DESCONTO as desc2, CLVND.VL_DESCONTO as DESC_GERAL, (CLVND.VL_DESCONTO / MVFNC.VL_ORIGINAL)*100 as DESC_PERC,
IIF(Cvdpc.ID_CLINICA_VENDA_DEVOLUCAO  IS NULL, '','ITEM DEVOLVIDO') ITEM_DEVOLVIDO,
ENDER.DS_LOGRADOURO_COMPLETO DS_ENDERECO,CLVND.CD_CLINICA_VENDA,
vl_original,
PESSO.CD_PESSOA,AGEND.CD_AGENDAMENTO, 
PESSO.DT_NASC_ABERTURA, 
CLVND.DH_VENDA,
AGEND.DH_AGENDAMENTO,PESSO.NO_PESSOA,PESSO_ATEND.NO_PESSOA NO_PESSOA_ATENDENTE,
ISNULL(CLVND.DS_SOLICITANTE, PESSO_SOLIC.NO_PESSOA) DS_SOLICITANTE,PESSO_PROFI.NO_PESSOA NO_PESSOA_PROFISSIONAL,
PROCE.NO_PROCEDIMENTO,OPCAO_TPPCD.NO_OPCAO NO_OPT_TIPOPROCEDIMENTO,CVDPC.VL_PROCEDIMENTO,CVDPC.VL_DESCONTO,OPCAO_TPEXM.NO_OPCAO NO_OPT_TIPOEXAME,
CONVE.NO_CONVENIO,PESSO.CD_CPF_CNPJ,PESSO.SQ_PESSOA,PTLPR.CD_NUMERO CD_TELEFONE,ISNULL(MVFNC.VL_DESCONTO, 0) VL_DESCONTO_MOVFINANCEIRA,CNSLT.NO_CONSULTORIO
FROM TB_CLINICA_VENDA CLVND INNER JOIN TB_CLINICA_VENDA_PROCEDIMENTO CVDPC ON CVDPC.ID_CLINICA_VENDA = CLVND.SQ_CLINICA_VENDA INNER JOIN TB_PESSOA PESSO_PROFI ON PESSO_PROFI.SQ_PESSOA = CVDPC.ID_PESSOA_PROFISSIONAL INNER JOIN TB_PROCEDIMENTO PROCE ON PROCE.SQ_PROCEDIMENTO = 
CVDPC.ID_PROCEDIMENTO AND PROCE.ID_OPT_TIPOPROCEDIMENTO = 726 LEFT JOIN TB_AGENDAMENTO AGEND ON (AGEND.SQ_AGENDAMENTO = CVDPC.ID_AGENDAMENTO OR  AGEND.ID_CLINICA_VENDA_PROCEDIMENTO = CVDPC.SQ_CLINICA_VENDA_PROCEDIMENTO) LEFT JOIN TB_PESSOA EMPRE ON EMPRE.SQ_PESSOA = AGEND.ID_EMPRESA
INNER JOIN TB_PESSOA PESSO ON PESSO.SQ_PESSOA = ISNULL(AGEND.ID_PESSOA, CLVND.ID_PESSOA)
 LEFT JOIN TB_PESSOA PESSO_SOLIC ON PESSO_SOLIC.SQ_PESSOA = AGEND.ID_PESSOA_PROFISSIONAL LEFT JOIN TB_OPCAO OPCAO_TPPCD ON OPCAO_TPPCD.SQ_OPCAO = PROCE.ID_OPT_TIPOPROCEDIMENTO LEFT JOIN TB_OPCAO OPCAO_TPEXM ON OPCAO_TPEXM.SQ_OPCAO = PROCE.ID_OPT_TIPOEXAME LEFT JOIN VW_ENDERECO_PRIMEIRO ENDER ON ENDER.ID_PESSOA = CLVND.ID_PESSOA AND ENDER.ID_TIPO_ENDERECO = 1 LEFT JOIN VW_ENDERECO_PRIMEIRO ENDE2 ON ENDE2.ID_PESSOA = AGEND.ID_EMPRESA AND ENDE2.ID_TIPO_ENDERECO = 2 LEFT JOIN TB_PESSOA PESSO_ATEND ON PESSO_ATEND.SQ_PESSOA = CLVND.ID_PESSOA_ATENDENTE LEFT JOIN TB_CONVENIO CONVE ON CONVE.SQ_CONVENIO = CLVND.ID_CONVENIO LEFT JOIN VW_PESSOA_TELEFONE_PRIMEIRO PTLPR ON PTLPR.ID_PESSOA = PESSO.SQ_PESSOA LEFT JOIN (SELECT ID_CLINICA_VENDA,SUM(VL_ORIGINAL) VL_ORIGINAL,SUM(VL_DESCONTO) VL_DESCONTO FROM TB_MOVFINANCEIRA WHERE ID_OPT_TIPOMOVFINANCEIRA = 45 GROUP BY ID_CLINICA_VENDA) MVFNC ON MVFNC.ID_CLINICA_VENDA = CLVND.SQ_CLINICA_VENDA 
 LEFT JOIN TB_CONSULTORIO CNSLT ON CNSLT.SQ_CONSULTORIO = AGEND.ID_CONSULTORIO
                  WHERE CLVND.SQ_CLINICA_VENDA = {iSQ_CLINICA_VENDA.ToString()}"
      oData = DBQuery(sSqlText,, True)
  ...
  Public Sub FormRelatorioMovimentacaoFinanceiraPrestacaoContas(iID_CONTA_FINANCEIRA As Integer,
    ...
    Try
      ...
      sSqlText = "SELECT IIF(MVFNC.ID_CLINICA_VENDA_DEVOLUCAO IS NULL, MVFNC.ID_OPT_TIPOMOVFINANCEIRA, 46.5) ID_OPT_TIPOMOVFINANCEIRA," &
                        ...
                        "SUM(MVFNP.VL_QUITADO) VL_PARCELA," &
                        "SUM((MVFNP.VL_QUITADO - ISNULL(MVFNP.VL_DESCONTO, 0) + ISNULL(DEVOL.VL_DEVOLUCAO, 0) + ISNULL(MVFNP.VL_DESCONTO_PAGTO, 0)) * IIF(MVFNC.ID_OPT_TIPOMOVFINANCEIRA=" & enOpcoes.TipoMovimentacaoFinanceiraRecebePagar_ContasPagar.GetHashCode() & ",-1,1)) VL_PARCELA_REAL," &
                        "SUM(IIF(TPDOC.SQ_TIPO_DOCUMENTO = " & const_TipoDocumento_Dinheiro & " OR 
                                 (MVFNC.ID_OPT_TIPOMOVFINANCEIRA=" & enOpcoes.TipoMovimentacaoFinanceiraRecebePagar_ContasPagar.GetHashCode() & " AND CVD.SQ_MOVFINANCEIRAPARCELA IS NULL), (MVFNP.VL_QUITADO - ISNULL(MVFNP.VL_DESCONTO, 0) - ISNULL(MVFNP.VL_DESCONTO_PAGTO, 0)) * IIF(MVFNC.ID_OPT_TIPOMOVFINANCEIRA=" & enOpcoes.TipoMovimentacaoFinanceiraRecebePagar_ContasPagar.GetHashCode() & ",-1,1),0)) VL_DINHEIRO_REAL," &
                 ...
                 " FROM TB_MOVFINANCEIRA MVFNC" &
                  ...
                  " LEFT JOIN (SELECT DISTINCT D3.SQ_MOVFINANCEIRAPARCELA" &
                              " FROM TB_CLINICA_VENDA_DEVOLUCAO D1" &
                               " INNER JOIN TB_MOVFINANCEIRA D2 ON D2.ID_CLINICA_VENDA = D1.ID_CLINICA_VENDA" &
                               " INNER JOIN TB_MOVFINANCEIRAPARCELA D3 ON D3.ID_MOVFINANCEIRA = D2.SQ_MOVFINANCEIRA" &
                              " WHERE D2.ID_OPT_STATUS NOT IN (60)) cvd on cvd.SQ_MOVFINANCEIRAPARCELA = MVFNP.SQ_MOVFINANCEIRAPARCELA" &
      ...
      sSqlText = $"SELECT IIF(MVFNC.ID_CLINICA_VENDA_DEVOLUCAO IS NULL, MVFNC.ID_OPT_TIPOMOVFINANCEIRA, 46.5) ID_OPT_TIPOMOVFINANCEIRA,
			                    IIF(MVFNC.ID_OPT_TIPOMOVFINANCEIRA = 46, MFPGTO.NO_PESSOA, MFPGTO.NO_TIPO_DOCUMENTO) NO_TIPO,
                          SUM(PGI.VL_PAGAMENTO) VL_PARCELA,
                          SUM(MFPGTO.VL_PARCELA) VL_PARCELA_REAL,
                          SUM(IIF(ISNULL(FPG.ID_TIPO_DOCUMENTO, MFPCL.ID_TIPO_DOCUMENTO) = 1, MFPGTO.VL_PAGAMENTO * IIF(MVFNC.ID_OPT_TIPOMOVFINANCEIRA=46,-1,1),0)) VL_DINHEIRO_REAL,
                          SUM(MFPGTO.VL_DESCONTO_PAGTO) VL_DESCONTO,
                          COUNT(*) QTDE
                    FROM VW_MOVFINANCEIRAPAGTO MFPGTO
										 INNER JOIN VW_PAGAMENTOITEM PGI ON PGI.ID_PAGAMENTO = MFPGTO.ID_PAGAMENTO
										  LEFT JOIN TB_FORMAPAGAMENTO FPG ON FPG.SQ_FORMAPAGAMENTO = PGI.ID_FORMAPAGAMENTO
                     INNER JOIN TB_MOVFINANCEIRAPARCELA MFPCL ON MFPCL.SQ_MOVFINANCEIRAPARCELA = MFPGTO.ID_MOVFINANCEIRAPARCELA
                     INNER JOIN TB_MOVFINANCEIRA MVFNC ON MVFNC.SQ_MOVFINANCEIRA = MFPCL.ID_MOVFINANCEIRA
                     INNER JOIN (SELECT DISTINCT ID_PAGAMENTO, ID_CONTAFINANCEIRA FROM TB_PAGAMENTOITEM) X ON X.ID_PAGAMENTO = MFPGTO.ID_PAGAMENTO
                    WHERE CAST(MFPGTO.DT_PAGAMENTO AS DATE) >= {FNC_QuotedStr(dDataInicial)}
                      AND CAST(MFPGTO.DT_PAGAMENTO AS DATE) <= {FNC_QuotedStr(dDataFinal)}
                      AND MVFNC.ID_OPT_TIPOMOVFINANCEIRA = {enOpcoes.TipoMovimentacaoFinanceiraRecebePagar_ContasPagar.GetHashCode()}
                      AND X.ID_CONTAFINANCEIRA = {iID_CONTA_FINANCEIRA}
                    GROUP BY MVFNC.ID_CLINICA_VENDA_DEVOLUCAO, MVFNC.ID_OPT_TIPOMOVFINANCEIRA,
                            IIF(MVFNC.ID_OPT_TIPOMOVFINANCEIRA = 46, MFPGTO.NO_PESSOA, MFPGTO.NO_TIPO_DOCUMENTO)
                  UNION ALL
                  SELECT IIF(MVFNC.ID_CLINICA_VENDA_DEVOLUCAO IS NULL, MVFNC.ID_OPT_TIPOMOVFINANCEIRA, 46.5) ID_OPT_TIPOMOVFINANCEIRA,
                        IIF(MVFNC.ID_OPT_TIPOMOVFINANCEIRA = {enOpcoes.TipoMovimentacaoFinanceiraRecebePagar_ContasPagar.GetHashCode()}, PESSO.NO_PESSOA, TPDOC.NO_TIPO_DOCUMENTO) NO_TIPO,
                        SUM(MVFNP.VL_QUITADO) VL_PARCELA,
                        SUM((MVFNP.VL_QUITADO - ISNULL(MVFNP.VL_DESCONTO, 0) + ISNULL(DEVOL.VL_DEVOLUCAO, 0) + ISNULL(MVFNP.VL_DESCONTO_PAGTO, 0)) * IIF(MVFNC.ID_OPT_TIPOMOVFINANCEIRA={enOpcoes.TipoMovimentacaoFinanceiraRecebePagar_ContasPagar.GetHashCode()},-1,1)) VL_PARCELA_REAL,
                        SUM(IIF(TPDOC.SQ_TIPO_DOCUMENTO = {const_TipoDocumento_Dinheiro} OR
                   ...
                   WHERE CAST(ISNULL(MVFNP.DT_QUITACAO, MVFNC.DT_LANCAMENTO) AS DATE) >= {FNC_QuotedStr(dDataInicial)}
                    ...
                    AND (MVFNC.ID_CONTAFINANCEIRA_CREDITO = {iID_CONTA_FINANCEIRA} OR
                         MVFNC.ID_CONTAFINANCEIRA_DEBITO = {iID_CONTA_FINANCEIRA})
                    AND DEVOL.ID_MOVFINANCEIRAPARCELA IS NULL
                    AND ISNULL(MVFNP.ID_FORMAPAGAMENTO_PREFERENCIAL, 0) <> 116
                   GROUP BY MVFNC.ID_CLINICA_VENDA_DEVOLUCAO, MVFNC.ID_OPT_TIPOMOVFINANCEIRA,
                            IIF(MVFNC.ID_OPT_TIPOMOVFINANCEIRA = {enOpcoes.TipoMovimentacaoFinanceiraRecebePagar_ContasPagar.GetHashCode()}, PESSO.NO_PESSOA, TPDOC.NO_TIPO_DOCUMENTO)
      ...
      sSqlText = "SELECT CONVE.NO_CONVENIO," &
                 ...
                 " WHERE CAST(MVFNC.DT_LANCAMENTO AS DATE) >= " & FNC_QuotedStr(dDataInicial) &
                   " AND CAST(MVFNC.DT_LANCAMENTO AS DATE) <= " & FNC_QuotedStr(dDataFinal) &
                   " AND MVFNC.ID_OPT_TIPOMOVFINANCEIRA = " & enOpcoes.TipoMovimentacaoFinanceiraRecebePagar_ContasReceber.GetHashCode() &
                   " AND (MVFNC.ID_CONTAFINANCEIRA_CREDITO = " & iID_CONTA_FINANCEIRA.ToString() & " OR " &
                         "MVFNC.ID_CONTAFINANCEIRA_DEBITO = " & iID_CONTA_FINANCEIRA.ToString() & " ) " &
      ...
      sSqlText = $"SELECT MVFNC.ID_OPT_TIPOMOVFINANCEIRA,
                        ISNULL(PLCNT.NO_PLANOCONTAS, 'Sem plano de contas') NO_PLANOCONTAS,
                        SUM(ROUND(MVFNP.VL_PARCELA / 100 * ISNULL(PC_PARTICIPACAO, 100), 2)) VL_PARCELA_REAL,
                        COUNT(*) QTDE
                    FROM TB_MOVFINANCEIRA MVFNC
                   INNER JOIN TB_MOVFINANCEIRAPARCELA MVFNP ON MVFNP.ID_MOVFINANCEIRA = MVFNC.SQ_MOVFINANCEIRA
                  ...
                  WHERE CAST(MVFNC.DT_LANCAMENTO AS DATE) >= {FNC_QuotedStr(dDataInicial)}
                    AND CAST(MVFNC.DT_LANCAMENTO AS DATE) <= {FNC_QuotedStr(dDataFinal)}
                    AND MVFNP.ID_OPT_STATUS NOT IN ({ enOpcoes.StatusMovimentacaoFinanceira_Cancelada.GetHashCode()})
                    AND ((MVFNC.ID_OPT_TIPOMOVFINANCEIRA = {enOpcoes.TipoMovimentacaoFinanceiraRecebePagar_ContasReceber.GetHashCode()} AND
                          MVFNC.ID_CONTAFINANCEIRA_CREDITO = {iID_CONTA_FINANCEIRA.ToString()}) OR
                         (MVFNC.ID_OPT_TIPOMOVFINANCEIRA = {enOpcoes.TipoMovimentacaoFinanceiraRecebePagar_ContasPagar.GetHashCode()} AND
                          MVFNC.ID_CONTAFINANCEIRA_DEBITO = {iID_CONTA_FINANCEIRA.ToString()}))
      ...
      sSqlText = $"SELECT MVFNC.ID_OPT_TIPOMOVFINANCEIRA,
                   ...
                   GROUP BY MVFNC.ID_OPT_TIPOMOVFINANCEIRA,
			                      TPDOC.NO_TIPO_DOCUMENTO"
      oDadosReceitas = DBQuery(sSqlText)

      sSqlText = $"SELECT MVFNC.ID_OPT_TIPOMOVFINANCEIRA,
			                    ISNULL(PLCNT.NO_PLANOCONTAS, 'Sem plano de contas')  NO_TIPO_DOCUMENTO,
                          SUM(ROUND(MVFNP.VL_PARCELA / 100 * ISNULL(PC_PARTICIPACAO, 100), 2)) VL_PARCELA,
                          COUNT(*) QTDE
                    FROM TB_MOVFINANCEIRA MVFNC
                    INNER JOIN TB_MOVFINANCEIRAPARCELA MVFNP ON MVFNP.ID_MOVFINANCEIRA = MVFNC.SQ_MOVFINANCEIRA
                     LEFT JOIN TB_MOVFINANCEIRA_PLANOCONTAS MVPLC ON MVPLC.ID_MOVFINANCEIRA = MVFNC.SQ_MOVFINANCEIRA
                     LEFT JOIN TB_PLANOCONTAS PLCNT ON PLCNT.SQ_PLANOCONTAS = MVPLC.ID_PLANOCONTAS
                    INNER JOIN TB_PESSOA_EMPRESA PE ON PE.ID_PESSOA = MVFNC.ID_PESSOA
	                                                 AND PE.ID_EMPRESA = MVFNC.ID_EMPRESA
																                   AND ISNULL(PE.IC_PROFISSIONAL, 'N') = 'S'
                    INNER JOIN TB_TIPO_DOCUMENTO TPDOC ON TPDOC.SQ_TIPO_DOCUMENTO = MVFNP.ID_TIPO_DOCUMENTO
                    INNER JOIN TB_PESSOA PESSO ON PESSO.SQ_PESSOA = MVFNC.ID_PESSOA
                   WHERE CAST(MVFNC.DT_LANCAMENTO AS DATE) >= {FNC_QuotedStr(dDataInicial)}
                     AND CAST(MVFNC.DT_LANCAMENTO AS DATE) <= {FNC_QuotedStr(dDataFinal)}
                     AND MVFNC.ID_CLINICA_VENDA Is Not NULL
                     AND MVFNC.ID_OPT_TIPOMOVFINANCEIRA = {enOpcoes.TipoMovimentacaoFinanceiraRecebePagar_ContasPagar.GetHashCode()}
                     AND (MVFNC.ID_CONTAFINANCEIRA_CREDITO = {iID_CONTA_FINANCEIRA} OR
                          MVFNC.ID_CONTAFINANCEIRA_DEBITO = {iID_CONTA_FINANCEIRA})
                   GROUP BY MVFNC.ID_OPT_TIPOMOVFINANCEIRA,
			                      ISNULL(PLCNT.NO_PLANOCONTAS, 'Sem plano de contas')"
      oDadosRepasse = DBQuery(sSqlText)
      ...
      With oForm.rpvGeral
        ...
        .LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("DadosReceitas", oDadosReceitas))
        .LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("DadosRepasse", oDadosRepasse))
        .RefreshReport()
        oForm.Show()
      End With
    Catch ex As Exception
  ...
  Public Sub FormRelatorioFinanceiro_Recibo_Pagamento(iSQ_MOVFINANCEIRAPARCELA As Integer,
    ...
    Try
      ...
      sSqlText = "SELECT MVFNP.DT_VENCIMENTO," &
                        ...
                        "MVFNP.VL_IMPOSTORETIDO, " &
                        "MVFNP.VL_QUITADO," &
                        "MVFNP.VL_PARCELA -MVFNP.VL_QUITADO -MVFNP.VL_IMPOSTORETIDO as saldodevedor," &
                        "MVFNC.SQ_MOVFINANCEIRA" &
                 " FROM TB_MOVFINANCEIRA MVFNC" &
                  " INNER JOIN TB_PESSOA PESSO ON PESSO.SQ_PESSOA = MVFNC.ID_PESSOA" &
                  " INNER JOIN TB_CONTAFINANCEIRA CTFIN_D ON CTFIN_D.SQ_CONTAFINANCEIRA = MVFNC.ID_CONTAFINANCEIRA_DEBITO" &
                  " INNER JOIN TB_MOVFINANCEIRAPARCELA MVFNP ON MVFNP.ID_MOVFINANCEIRA = MVFNC.SQ_MOVFINANCEIRA" &
                 " WHERE MVFNP.SQ_MOVFINANCEIRAPARCELA  = " & iSQ_MOVFINANCEIRAPARCELA.ToString()

      sSqlText = $"SELECT PGIT.DT_PAGAMENTO DT_VENCIMENTO,
                          PGIT.NO_PESSOA,
                          ...
                          SUM(PGIT.VL_IMPOSTORETIDO) VL_IMPOSTORETIDO,
			                    ...
			                    PGIT.NO_CONTAFINANCEIRA,
			                    PGIT.ID_MOVFINANCEIRA SQ_MOVFINANCEIRA
                    FROM VW_PAGAMENTOITEM PGIT
                    WHERE PGIT.ID_MOVFINANCEIRAPARCELA = {iSQ_MOVFINANCEIRAPARCELA}"

      If iID_CONTAFINANCEIRA > 0 Then
        sSqlText = sSqlText & $" AND ID_CONTAFINANCEIRA = {iID_CONTAFINANCEIRA}"
      End If
      If iSQ_PAGAMENTO > 0 Then
        sSqlText = sSqlText & $" AND ID_PAGAMENTO = {iSQ_PAGAMENTO}"
      End If

      sSqlText = sSqlText + $"
                    GROUP BY PGIT.DT_PAGAMENTO,
                             PGIT.NO_PESSOA,
			                       PGIT.DS_MOVFINANCEIRA,
			                       dbo.FC_PAGAMENTO_PAGAMENTO_MOVFINANCEIRA_FORMASPAGTO(PGIT.ID_MOVFINANCEIRA),
			                       dbo.FC_MOVFINANCEIRA_PLANOSCONTA(PGIT.ID_MOVFINANCEIRA),
			                       PGIT.NO_CONTAFINANCEIRA,
			                       PGIT.ID_MOVFINANCEIRA"
      oData = DBQuery(sSqlText)

      sSqlText = "SELECT TOP 4 FPGTO.NO_FORMAPAGAMENTO," &
                              "MVFNP.CD_DOCUMENTO," &
                              "PAGTO.DT_PAGAMENTO DT_VENCIMENTO," &
                              "PAGIT.VL_PAGAMENTO" &
                 " FROM TB_PAGAMENTOITEM_MOVFINANCEIRA PGIMF" &
                  ...
                  " INNER JOIN TB_PAGAMENTO PAGTO ON PAGTO.SQ_PAGAMENTO = PAGIT.ID_PAGAMENTO" &
      ...
      If iID_CONTAFINANCEIRA > 0 Then
        sSqlText = sSqlText & $" AND PAGIT.ID_CONTAFINANCEIRA = {iID_CONTAFINANCEIRA}"
      End If
      If iSQ_PAGAMENTO > 0 Then
        sSqlText = sSqlText & $" AND PAGIT.ID_PAGAMENTO = {iSQ_PAGAMENTO}"
      End If
      oDados_FPGTO = DBQuery(sSqlText)

      sSqlText = "SELECT PG.DS_MOVFINANCEIRA," &
                        "PG.DT_MOVIMENTACAO," &
                        "PG.DT_VENCIMENTO," &
                        "PG.VL_PARCELA" &
  ...
  Public Sub FormRelatorioAtestadoAcompanhante(iSQ_PESSOA_ATESTADO As Integer, bImprimir As Boolean)
    Try
      ...
      sSqlText = "Select CLATD.DH_CLINICA_ATENDIMENTO," &
                        ...
                        "IIF(DATEPART(HOUR, CLATD.DH_CLINICA_ATENDIMENTO) < 13, 'Matutino', 'Vespertino') DS_TURNO_ATESTADO" &
  ...
  Public Sub FormRelatorioAtestadoComparecimento(iSQ_PESSOA_ATESTADO As Integer, bImprimir As Boolean)
    Try
      ...
      sSqlText = "Select PSATT.DH_PESSOA_ATESTADO," &
                        "PESSO.NO_PESSOA," &
                        "PSATT.DS_ACOMPANHANTE," &
                        "IIF(DATEPART(HOUR, PSATT.DH_PESSOA_ATESTADO) < 13, 'Matutino', 'Vespertino') DS_TURNO_ATESTADO" &
                 " FROM TB_PESSOA_ATESTADO PSATT" &
                  " INNER JOIN TB_PESSOA PESSO On PESSO.SQ_PESSOA = PSATT.ID_PESSOA" &
                 " WHERE PSATT.SQ_PESSOA_ATESTADO =  " & iSQ_PESSOA_ATESTADO.ToString()
      oData = DBQuery(sSqlText)
    ...
    Try
      ...
      sSqlText = $"SELECT DISTINCT MVFNC.DT_MOVIMENTACAO,
                    ...
                    FROM TB_MOVFINANCEIRA MVFNC
                     ...
                     INNER JOIN TB_PESSOA PESSO ON PESSO.SQ_PESSOA = CLVND.ID_PESSOA
                     INNER JOIN TB_CLINICA_VENDA_PROCEDIMENTO CLVNDI ON CLVNDI.ID_CLINICA_VENDA = CLVND.SQ_CLINICA_VENDA AND CLVNDI.ID_MOVFINANCEIRA = MVFNP.ID_MOVFINANCEIRA
                    ...
                    WHERE MVFNC.SQ_MOVFINANCEIRA = {iID_MOVFINANCEIRA.ToString()}
                      AND CVPRC.ID_OPT_STATUS = {enOpcoes.StatusVendaClinica_RepasseRealizado.GetHashCode()}"
      oData = DBQuery(sSqlText)
  ...
  Public Sub FormRelatorioExameExterno(iSQ_CLINICA_VENDA As Integer, bImprimir As Boolean)
    Try
      ...
      sSqlText = "SELECT PESSO_PROFI.SQ_PESSOA SQ_PESSOA_PROFISSIONAL,CONCAT(IIF(PROCE.ID_OPT_TIPOEXAME = 729," &
"CAST(PROCE.SQ_PROCEDIMENTO  AS VARCHAR(10)), '0'), '.', CAST(PESSO_PROFI.SQ_PESSOA AS VARCHAR(10))) IC_QUEBRAPAGINA," &
"PESSO_PROFI.NO_PESSOA NO_PESSOA_PROFISSIONAL," &
"ENDER_PROFI.DS_LOGRADOURO_COMPLETO DS_ENDERECO_PROFISSIONAL," &
"IIF(Cvdpc.ID_CLINICA_VENDA_DEVOLUCAO  IS NULL, '','ITEM DEVOLVIDO') ITEM_DEVOLVIDO," &
"CLVND.CD_CLINICA_VENDA,ISNULL(CVDPC.DS_SOLICITANTE," &
"PESSO_SOLIC.NO_PESSOA) DS_SOLICITANTE,PESSO.CD_PESSOA,PESSO.NO_PESSOA,PESSO.DT_NASC_ABERTURA,dbo.FC_FormatarCPF_CNPJ(PESSO.CD_CPF_CNPJ) CD_CPF_CNPJ," &
"ENDER.DS_LOGRADOURO_COMPLETO,ENDER.NO_CIDADE," &
"PROCE.NO_PROCEDIMENTO,CVDPC.VL_PROCEDIMENTO ," &
"CVDPC.paciente_atendimento_nome," &
"CVDPC.paciente_atendimento_cpf," &
"CVDPC.VL_DESCONTO, CLVND.VL_DESCONTO as DESC_GERAL, (CLVND.VL_DESCONTO / MVFNC.VL_ORIGINAL)*100 as DESC_PERC, PESSO_ATEND.NO_PESSOA NO_PESSOA_ATENDENTE,CLVND.DH_VENDA,AGEND.DH_AGENDAMENTO,PESSO.SQ_PESSOA,PTLPR.CD_NUMERO CD_TELEFONE,ISNULL(MVFNC.VL_ORIGINAL, 0) VL_ORIGINAL,ISNULL(MVFNC.VL_DESCONTO, 0) VL_DESCONTO_MOVFINANCEIRA FROM TB_CLINICA_VENDA_PROCEDIMENTO CVDPC INNER JOIN TB_CLINICA_VENDA CLVND ON CLVND.SQ_CLINICA_VENDA = CVDPC.ID_CLINICA_VENDA INNER JOIN TB_PROCEDIMENTO PROCE ON PROCE.SQ_PROCEDIMENTO = CVDPC.ID_PROCEDIMENTO And PROCE.ID_OPT_TIPOPROCEDIMENTO Not IN (726) INNER JOIN TB_PESSOA PESSO_PROFI ON PESSO_PROFI.SQ_PESSOA " &
" = CVDPC.ID_PESSOA_PROFISSIONAL INNER JOIN TB_EMPRESA EMPRE ON EMPRE.ID_EMPRESA = CLVND.ID_EMPRESA INNER JOIN TB_PESSOA_EMPRESA PSEMP ON PSEMP.ID_PESSOA = CVDPC.ID_PESSOA_PROFISSIONAL And PSEMP.ID_EMPRESA = EMPRE.ID_EMPRESA_MATRIZ And ISNULL(PSEMP.IC_PROFISSIONAL_SERVICO_INTERNO, 'N') = 'N' LEFT JOIN VW_ENDERECO_PRIMEIRO ENDER_PROFI ON ENDER_PROFI.ID_PESSOA = CVDPC.ID_PESSOA_PROFISSIONAL AND ENDER_PROFI.ID_TIPO_ENDERECO = 2 INNER JOIN TB_PESSOA PESSO ON PESSO.SQ_PESSOA = CLVND.ID_PESSOA LEFT JOIN TB_AGENDAMENTO AGEND ON AGEND.SQ_AGENDAMENTO = CVDPC.ID_AGENDAMENTO LEFT JOIN TB_PESSOA PESSO_SOLIC ON PESSO_SOLIC.SQ_PESSOA = AGEND.ID_PESSOA_PROFISSIONAL LEFT JOIN VW_ENDERECO_PRIMEIRO ENDER ON ENDER.ID_PESSOA = CLVND.ID_PESSOA AND ENDER.ID_TIPO_ENDERECO = 1 LEFT JOIN TB_PESSOA PESSO_ATEND ON PESSO_ATEND.SQ_PESSOA = CLVND.ID_PESSOA_ATENDENTE LEFT JOIN VW_PESSOA_TELEFONE_PRIMEIRO PTLPR ON PTLPR.ID_PESSOA = PESSO.SQ_PESSOA LEFT JOIN (SELECT ID_CLINICA_VENDA,SUM(VL_ORIGINAL) VL_ORIGINAL,SUM(VL_DESCONTO) VL_DESCONTO FROM" &
 " TB_MOVFINANCEIRA WHERE ID_OPT_TIPOMOVFINANCEIRA = 45 GROUP BY ID_CLINICA_VENDA) MVFNC ON MVFNC.ID_CLINICA_VENDA = CLVND.SQ_CLINICA_VENDA" &
                 " WHERE CLVND.SQ_CLINICA_VENDA = " & iSQ_CLINICA_VENDA.ToString()
      oData = DBQuery(sSqlText)
  ...
  Public Sub FormRelatorioExameInterno(iSQ_CLINICA_VENDA As Integer, bImprimir As Boolean)
    Try
      ...
      sSqlText = $"SELECT CVDPC.SQ_CLINICA_VENDA_PROCEDIMENTO,
                          ...
                          PESSO_AG.NO_PESSOA AS AGENDADO,
                          PESSO.SQ_PESSOA,
                          PESSO.NO_PESSOA,
                          PESSO.DT_NASC_ABERTURA,
                          ...
                          ISNULL(MVFNC.VL_DESCONTO, 0) VL_DESCONTO_MOVFINANCEIRA,
	                        CVDPC.VL_DESCONTO AS DESC2,
                          CLVND.VL_DESCONTO as DESC_GERAL,
                          (CLVND.VL_DESCONTO / MVFNC.VL_ORIGINAL)*100 as DESC_PERC,
                          CNSLT.NO_CONSULTORIO,
                          AGEMP.NO_PESSOA NO_EMPRESA_AGEND,
													EDEPA.DS_LOGRADOURO_COMPLETO DS_LOGRADOURO_AGEND
                    FROM TB_CLINICA_VENDA_PROCEDIMENTO CVDPC
                     ...
                     INNER JOIN TB_PESSOA PESSO ON PESSO.SQ_PESSOA = CLVND.ID_PESSOA
                      LEFT JOIN TB_AGENDAMENTO AGEND ON (AGEND.SQ_AGENDAMENTO = CVDPC.ID_AGENDAMENTO OR AGEND.ID_CLINICA_VENDA_PROCEDIMENTO = CVDPC.SQ_CLINICA_VENDA_PROCEDIMENTO)
                      LEFT JOIN TB_PESSOA AGEMP ON AGEMP.SQ_PESSOA = AGEND.ID_EMPRESA
                      LEFT JOIN VW_ENDERECO_PRIMEIRO EDEPA ON EDEPA.ID_PESSOA = AGEND.ID_EMPRESA
                                                          AND EDEPA.ID_TIPO_ENDERECO = {enTipoEndereco.Comercial.GetHashCode()}
                      LEFT JOIN TB_PESSOA PESSO_SOLIC ON PESSO_SOLIC.SQ_PESSOA = CVDPC.ID_PESSOA_PROFISSIONAL_SOLICITANTE
                      LEFT JOIN TB_PESSOA PESSO_AG ON PESSO_AG.SQ_PESSOA = AGEND.ID_PESSOA
                      ...
                      LEFT JOIN (SELECT ID_CLINICA_VENDA,
                                  ...
                                  WHERE ID_OPT_TIPOMOVFINANCEIRA = 45
                                  GROUP BY ID_CLINICA_VENDA) MVFNC ON MVFNC.ID_CLINICA_VENDA = CLVND.SQ_CLINICA_VENDA
                      LEFT JOIN TB_CONSULTORIO CNSLT ON CNSLT.SQ_CONSULTORIO = AGEND.ID_CONSULTORIO
                    WHERE CLVND.SQ_CLINICA_VENDA = {iSQ_CLINICA_VENDA.ToString()}
                      AND AGEND.ID_OPT_STATUS <> {enOpcoes.StatusAgendamento_Sistema_Remarcado.GetHashCode()}"
      oData = DBQuery(sSqlText)
      ...
      sSqlText = "SELECT OCCLI.CD_ORCAMENTO_CLIENTE," &
                 ...
                 " FROM TB_ORCAMENTO_CLIENTE OCCLI" &
                  ...
                  " INNER JOIN TB_EMPRESA EMPRE ON EMPRE.ID_EMPRESA = OCCLI.ID_EMPRESA" &
                   ...
                   " LEFT JOIN TB_CONVENIO CONVE ON CONVE.SQ_CONVENIO = OCCLI.ID_CONVENIO" &
                   " LEFT JOIN TB_FINANCIAMENTO FINAN ON FINAN.SQ_FINANCIAMENTO = OCCLI.ID_FINANCIAMENTO" &
                   " LEFT JOIN TB_OPCAO OPCAO_STATU ON OPCAO_STATU.SQ_OPCAO = OCCLI.ID_OPT_STATUS" &
