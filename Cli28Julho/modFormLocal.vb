...
" CONVE.NO_CONVENIO,PESSO.CD_CPF_CNPJ,PESSO.SQ_PESSOA,PTLPR.CD_NUMERO CD_TELEFONE,ISNULL(MVFNC.VL_DESCONTO, 0) VL_DESCONTO_MOVFINANCEIRA FROM TB_CLINICA_VENDA CLVND INNER JOIN TB_CLINICA_VENDA_PROCEDIMENTO CVDPC ON CVDPC.ID_CLINICA_VENDA = CLVND.SQ_CLINICA_VENDA INNER JOIN TB_PESSOA PESSO_PROFI ON PESSO_PROFI.SQ_PESSOA = CVDPC.ID_PESSOA_PROFISSIONAL INNER JOIN TB_PROCEDIMENTO PROCE ON PROCE.SQ_PROCEDIMENTO =  " &
