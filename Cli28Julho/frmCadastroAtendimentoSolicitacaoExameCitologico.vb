  ...
  Private Sub frmCadastroAtendimentoSolicitacaoExameCitologico_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    If iID_CLINICA_ATENDIMENTO > 0 Then
      ...
      If Trim(txtMedicoExterno.Text) = "" Then
        sSqlText = "SELECT ISNULL(PESSO_SOLIC.NO_PESSOA, CLVND.DS_SOLICITANTE)" &
                   " FROM TB_CLINICA_ATENDIMENTO CLATD" &
                    ...
                    " LEFT JOIN TB_PESSOA PESSO_SOLIC ON PESSO_SOLIC.SQ_PESSOA = ISNULL(CVPCDG.ID_PESSOA_PROFISSIONAL_SOLICITANTE, CVPCDA.ID_PESSOA_PROFISSIONAL_SOLICITANTE)" &
                   ...
                   " WHERE CLATD.SQ_CLINICA_ATENDIMENTO = " & iID_CLINICA_ATENDIMENTO &
                     " AND ISNULL(PESSO_SOLIC.NO_PESSOA, CLVND.DS_SOLICITANTE) IS NOT NULL"
