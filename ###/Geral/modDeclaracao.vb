...
Module modDeclaracao
  ...
  '>> Constantes
  '> Sistemas
  Public Const const_Sistema_NomePDV As String = "UNNO PDV"
  'Public Const const_Sistema_Nome As String = "UNNO Sistema"
  Public Const const_Sistema_Nome As String = "Sistema DixMed"
  Public Const const_Sistema_Chave As String = "FE0416"
  ...
  Public Const const_Formato_Valor_6casas As String = "R$ ###,###,##0.000000"
  ...
  Public Const const_FormaPagamento_DepositoBancario As Integer = 100
  ...
  Public Enum enOpcoes
    ...
    Processo_Historico_Cadastro_CadastroDepartamento = 480
    Processo_Historico_Cadastro_CadastroProduto = 481
    Processo_Historico_Cadastro_CadastroGrupoProduto = 482
    Processo_Historico_Cadastro_CadastroUnidadeMedida = 483
    ...
    Processo_Historico_Cadastro_CadastroMotivoDoenca = 488
    ...
    Processo_Historico_Cadastro_CadastroTipoTelefone = 516
    ...
    StatusAgendamento_Aguardando = 569
    ...
    StatusAtendimentoClinica_Confirmado = 581
